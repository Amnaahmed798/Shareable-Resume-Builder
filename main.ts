...
function generateResume(): void {
  ...
  button.addEventListener("click", () => {
    ...
    const resumeContent =
      document.getElementById("resumetemplate")?.outerHTML ||
  ...
  (document.getElementById("emailt") as HTMLElement).innerHTML = (
    document.getElementById("email") as HTMLInputElement
  ).value;
  (document.getElementById("professiont") as HTMLElement).innerHTML = (
    document.getElementById("profession") as HTMLInputElement
  ).value;
  (document.getElementById("contactt") as HTMLElement).innerHTML = (
    document.getElementById("contact") as HTMLInputElement
  ).value;
  (document.getElementById("locationt") as HTMLElement).innerHTML = (
    document.getElementById("location") as HTMLInputElement
  ).value;

  // Links
  const facebookLinkInput = document.getElementById(
    "facebook-link"
  ) as HTMLInputElement;
  const linkedinLinkInput = document.getElementById(
    "linkedin-link"
  ) as HTMLInputElement;
  ...
  const facebookElement = document.getElementById(
    "facebooklink"
  ) as HTMLAnchorElement;
  facebookElement.innerHTML = facebookLink;
  facebookElement.href = facebookLink;

  const linkedinElement = document.getElementById(
    "linkedinlink"
  ) as HTMLAnchorElement;
  ...
  // About Me
  const about = (document.getElementById("aboutarea") as HTMLTextAreaElement)
    .value;
  (document.getElementById("aboutmet") as HTMLElement).innerHTML = about;

  // Skills
  const skills = (document.getElementById("skillsarea") as HTMLTextAreaElement)
    .value;
  (document.getElementById("skillst") as HTMLElement).innerHTML =
    skills.replace(/\n/g, "<br>");

  // Education
  const school = (document.getElementById("school") as HTMLInputElement).value;
  const schoolYear = (
    document.getElementById("school-year") as HTMLInputElement
  ).value;
  const schoolCertificate = (
    document.getElementById("school-certificate") as HTMLInputElement
  ).value;

  const highschool = (document.getElementById("highschool") as HTMLInputElement)
    .value;
  const highschoolYear = (
    document.getElementById("highschool-year") as HTMLInputElement
  ).value;
  const highschoolCertificate = (
    document.getElementById("highschool-certificate") as HTMLInputElement
  ).value;

  const university = (document.getElementById("university") as HTMLInputElement)
    .value;
  const universityYear = (
    document.getElementById("university-year") as HTMLInputElement
  ).value;
  const universityCertificate = (
    document.getElementById("university-certificate") as HTMLInputElement
  ).value;
  ...
  (document.getElementById("educationContent") as HTMLElement).innerHTML =
    educationHTML;

  // Experience
  const experience = (
    document.getElementById("experiencearea") as HTMLTextAreaElement
  ).value;
  (document.getElementById("experiencet") as HTMLElement).innerHTML =
    experience.replace(/\n/g, "<br>");

  // Projects
  const projects = (
    document.getElementById("projectsarea") as HTMLTextAreaElement
  ).value;
  (document.getElementById("projectst") as HTMLElement).innerHTML =
    projects.replace(/\n/g, "<br>");
...
(document.getElementById("fileInput") as HTMLInputElement).addEventListener(
  "change",
