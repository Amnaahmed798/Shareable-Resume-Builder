...
function generateResume() {
    ...
    document.getElementById("generateUrlButton").addEventListener("click", function () {
        ...
        const userUrl = `${window.location.origin}/view?user=${encodeURIComponent(sanitizedUsername)}`;
    ...
    // About Me
    document.getElementById("aboutmet").innerHTML = document.getElementById("aboutarea").value || "";
    ...
    // Education
    var educationHTML = `
        <b>${document.getElementById("school").value || "School Name Not Provided"}</b><br>
        ${document.getElementById("school-certificate").value || "Certificate Not Provided"}<br>
        ${document.getElementById("school-year").value || "Year Not Provided"}<br><br>
        <b>${document.getElementById("highschool").value || "High School Name Not Provided"}</b><br>
        ${document.getElementById("highschool-certificate").value || "Certificate Not Provided"}<br>
        ${document.getElementById("highschool-year").value || "Year Not Provided"}<br><br>
        <b>${document.getElementById("university").value || "University Name Not Provided"}</b><br>
        ${document.getElementById("university-certificate").value || "Certificate Not Provided"}<br>
        ${document.getElementById("university-year").value || "Year Not Provided"}<br>
    `;
    document.getElementById("educationContent").innerHTML = educationHTML;

    // Experience
    document.getElementById("experiencet").innerHTML =
        document.getElementById("experiencearea").value.replace(/\n/g, "<br>");

    // Projects
    document.getElementById("projectst").innerHTML =
        document.getElementById("projectsarea").value.replace(/\n/g, "<br>");
